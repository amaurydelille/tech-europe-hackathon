...
Read `inputs/lesson.md`. Note the key subjects, settings, and characters that will recur. Note the rough overall length you're aiming for: roughly **30–90 seconds** of finished video for a typical lesson.
